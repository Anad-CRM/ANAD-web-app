            ...
            <div key={item.href} className="flex flex-col gap-1">
              {hasSubItems ? (
                <button
                  ...
                  className={`flex items-center justify-between px-3 py-2.5 rounded-[12px] text-[14px] font-medium transition-all duration-200 ${active ? "font-bold" : ""}`}
                  style={{
                ...
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-[12px] text-[14px] font-medium transition-all duration-200 ${active ? "font-bold" : ""}`}
                  style={{
                    backgroundColor: active ? COLORS.primaryXlight : "transparent",
                    color: active ? COLORS.text : "rgba(255,255,255,0.8)",
                  }}
                  ...
                  {item.subItems!.map((subItem) => {
                    ...
                    return (
                      <Link
                        ...
                        href={subItem.href}
                        onClick={() => setSidebarOpen(false)}
                        className={`flex items-center px-3 py-2 rounded-[8px] text-[13px] transition-all duration-200 ${subActive ? "font-bold text-white bg-white/10" : "text-white/60 hover:text-white hover:bg-white/5"}`}
                      >
                        {subItem.label}
                      </Link>
                    )
