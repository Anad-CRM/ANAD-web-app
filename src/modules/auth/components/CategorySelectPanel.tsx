      ...
      <div className="flex flex-col items-center gap-[12px] w-full">
        {CATEGORIES.map((cat) => (
          <button
            ...
            className="w-full max-w-[360px] flex items-center gap-[16px] px-[20px] sm:px-[24px] py-[14px] rounded-[14px] transition-all duration-200 cursor-pointer text-left shadow-[0_4px_12px_rgba(0,0,0,0.06)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.12)] border border-transparent hover:border-gray-100"
