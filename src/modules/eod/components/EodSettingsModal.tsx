  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
        {/* Header */}
        <div className="px-4 sm:px-8 py-5 sm:py-6 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
          <div>
            <Text as="h2" size="xl" weight="bold" className="text-gray-900">EOD Settings</Text>
            <Text as="p" size="sm" className="text-gray-500 mt-0.5">Configure how daily reporting works</Text>
          </div>
          <button 
            onClick={onClose}
        ...
        <div className="max-h-[70vh] overflow-y-auto px-4 sm:px-8 py-4 sm:py-6 space-y-6 sm:space-y-8">
          {/* EOD Mode Section */}
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button 
                ...
                className={`p-5 rounded-2xl border-2 transition-all text-left flex items-start gap-4 ${
                  mode === 'manual' 
                    ? 'border-[#163172] bg-[#163172]/5 ring-4 ring-[#163172]/5' 
                    : 'border-gray-100 hover:border-gray-200 bg-white'
                }`}
              >
                <div className={`p-2.5 rounded-xl ${mode === 'manual' ? 'bg-[#163172] text-white' : 'bg-gray-100 text-gray-500'}`}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                </div>
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <span className={`font-bold ${mode === 'manual' ? 'text-[#163172]' : 'text-gray-900'}`}>Manual</span>
                    {mode === 'manual' && (
                       <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-[#163172]"><path d="M20 6L9 17l-5-5"/></svg>
                    )}
                  </div>
              ...
              >
                <div className={`p-2.5 rounded-xl ${mode === 'auto' ? 'bg-[#163172] text-white' : 'bg-gray-100 text-gray-500'}`}>
                ...
                <div className="flex-1">
                 <div className="flex items-center justify-between">
                    <span className={`font-bold ${mode === 'auto' ? 'text-[#163172]' : 'text-gray-900'}`}>Automatic</span>
                    {mode === 'auto' && (
                       <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="text-[#163172]"><path d="M20 6L9 17l-5-5"/></svg>
                    )}
                  </div>
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {mode === 'manual' && !showAddField && (
                <button 
                  ...
                  className="text-xs font-bold text-[#163172] px-3 py-1.5 bg-[#163172]/5 rounded-lg hover:bg-[#163172]/10 transition-colors flex items-center gap-1.5"
                >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input 
                      ...
                      className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#163172]/20 focus:border-[#163172] outline-none transition-all text-sm"
                    />
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <select 
                      ...
                      className="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#163172]/20 focus:border-[#163172] outline-none transition-all text-sm appearance-none"
                    >
                      ...
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all border ${
                          requiredRoles.includes(role)
                            ? 'bg-[#163172] text-white border-[#163172]'
                ...
                {fields.map((field) => (
                  <div key={field.id} className="p-4 flex items-center justify-between hover:bg-gray-50/50 transition-colors">
                    <div className="flex items-center gap-3">
                      <div className="p-2 bg-[#163172]/5 text-[#163172] rounded-lg">
                    ...
                    <div className="flex items-center gap-1">
                      <button 
                        ...
                        className="p-2 text-gray-400 hover:text-[#163172] hover:bg-[#163172]/5 rounded-lg transition-all"
                      >
        ...
        {/* Footer */}
        <div className="px-4 sm:px-8 py-4 sm:py-5 border-t border-gray-100 bg-gray-50/50 flex justify-end">
          <Button 
            variant="primary"
            onClick={onClose}
            className="px-8 py-2.5 rounded-xl font-bold text-sm shadow-lg shadow-[#163172]/20"
          >
            Done
          </Button>
        </div>
