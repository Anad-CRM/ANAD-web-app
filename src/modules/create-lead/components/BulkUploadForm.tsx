...
export const BulkUploadForm: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      {status.type && (
        <div className={`mb-8 p-4 rounded-2xl flex items-center gap-3 border ${status.type === 'success' ? 'bg-green-50 border-green-100 text-green-700' : 'bg-red-50 border-red-100 text-red-700'
          }`}>
