  ...
  return (
    <div className="flex flex-col gap-[22px]">
      <div className="mb-6">
        ...
        <Text size="custom" className="text-gray-500 mt-2">
          ...
          {staffs.map((staff, idx) => (
            <div key={idx} className="bg-white border border-[#E2E8F0] rounded-2xl p-5 shadow-[0_4px_24px_rgba(0,0,0,0.04)] flex flex-col gap-4">
              <div className="flex items-center gap-4">
                <div className="w-[60px] h-[60px] rounded-full bg-gray-100 flex-shrink-0 overflow-hidden border border-gray-200">
                  {staff.avatar ? (
                    <img src={`https://api.anad.ae/uploads/${staff.avatar}`} alt="Avatar" className="w-full h-full object-cover" />
                  ) : (
                    <div className="w-full h-full flex items-center justify-center bg-[#E2E8F0] text-gray-500">
